...
const MEMBER_FIELDS = [
  { name: 'nameAr', labelKey: 'nameAr', placeholderKey: 'nameAr', required: true },
  { name: 'nameEn', labelKey: 'nameEn', placeholderKey: 'nameEn', required: true },
...
function createHelpers(form) {
  ...
  const getBorderClass = (path) => {
    ...
    if (dirty && value && value.toString().trim() !== '') return 'border-green-500'
    return ''
  }
    ...
    <div className='bg-white rounded-3xl p-6 shadow-[0_0_20px_rgba(255,255,255,0.5)]'>
      ...
      <div className='grid gap-5 md:grid-cols-2'>
        ...
        <div>
          ...
          <Select
            onValueChange={(value) => setValue('track', value, { shouldDirty: true })}
          >
            <SelectTrigger
      ...
      <div className='grid gap-5 mt-5'>
        ...
        <div>
          ...
          <Textarea
            ...
            rows={5}
          />
          <ErrorMessage message={form.formState.errors.ideaDescription?.message} />
        </div>
    ...
    <div className='border border-gray-200 rounded-xl p-4 mb-5'>
      <div className='flex justify-between items-center mb-4'>
        ...
        <div className='flex items-center gap-2'>
          <Label htmlFor={`leader-${index}`} className='text-sm font-medium mb-2'>
            {t('teamLeader')}
          </Label>
          <Input
            type='radio'
      ...
      <div className='grid md:grid-cols-2 gap-4'>
        ...
        <div>
          ...
          <ErrorMessage message={form.formState.errors.members?.[index]?.gender?.message} />
        </div>
        ...
        <div>
          ...
          <ErrorMessage message={form.formState.errors.members?.[index]?.university?.message} />
        </div>
        ...
        {uniValue === 'other' && (
          <div>
            ...
            />
            <ErrorMessage
              message={form.formState.errors.members?.[index]?.otherUniversity?.message}
            />
          </div>
        )}
      </div>
...
function ApplyPageContent() {
  const { t, form, fields, append, remove, watchMembers, watchAttachment } = useApplyForm()
